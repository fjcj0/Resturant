        ...
        <FullScreenTsx>
            <div className="max-w-5xl w-full m-3 bg-bg-color rounded-lg grid grid-cols-1 md:grid-cols-2">
                <div className="w-full flex-center flex-col gap-3 p-3">
                    <h1 className="font-bold text-3xl">انشاء الحساب للعميل</h1>
                ...
                <div className="w-full p-6 flex flex-col items-center justify-center">
                    ...
                    <div className="flex-start w-full px-3">
                        <p>لديك حساب؟ <Link to={'/auth/agent/login'} className="text-primary">
                            سحل دخول
                        </Link></p>
                    </div>
                </div>
...
export default AgentCreateAccountPage;